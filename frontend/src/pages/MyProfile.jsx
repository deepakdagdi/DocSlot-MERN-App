      ...
      <div className='mt-10'>
        {
          isEdit ?
            <button
              className='border border-primary px-8 py-2 rounded-md  hover:bg-primary
           hover:text-white transition-all'
              onClick={updateUserProfileDate}>Save Information</button>
            :
            <button className='border border-primary px-8 py-2 rounded-md hover:bg-primary
           hover:text-white transition-all'
