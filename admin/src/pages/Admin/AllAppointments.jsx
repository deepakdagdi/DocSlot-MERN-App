...
const AllAppointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll min-h-[70vh]'>
        ...
        </div>
        {
          appointments.map((item,index)=>(
            ...
            items-center text-gray-500 py-3 px-6 border-b hover:border-r-gray-50' key={index}>
              ...
              <div className='flex items-center gap-2'>
                ...
                <p>{currency}{item.amount}</p>
                {
                  ...
                  <img onClick={()=>cancelAppointment(item._id)} className="w10 cursor-pointer" src={assets.cancel_icon} alt=''/>
                  }
